...
<div id="top" class="top">
    <div class="wrap">
        ...
        <p class="welcome">欢迎来到医院预约挂号统一平台
        </p>
    </div>
</div>
...
<div id="nav" class="nav">
    <div class="wrap">
        ...
        <a class="link" href="${pageContext.request.contextPath}/guaCome" target="_parent">我要挂号</a>
        <a href="#" class="link">最新公告</a>
        <a class="link right" href="${pageContext.request.contextPath}/huoCome" target="_parent">后台管理</a>
    </div>
</div>
...
<div id="banner" class="banner">
    ...
    <div class="banner-search">
        ...
        <div class="form ui-cascading">
            ...
            <div class="line">
                <select name="department"  data-search="getDepartmentArrByHospitalName" data-where=""><option>医院科室3</option></select>
            </div>
