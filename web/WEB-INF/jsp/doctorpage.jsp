    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
                <dd><a onclick="x_admin_show('切换帐号','doctorOut')">切换帐号</a></dd>
                <dd><a href="${pageContext.request.contextPath}/doctorOut">退出</a></dd>
            </dl>
        </li>
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/doctorGua">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的挂号信息</cite>
                        </a>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show o_div">
                <span class="o_span">你好,${sessionScope.pa.d_name}医生</span>
            </div>
        </div>
    </div>
</div>
